...
Este projeto foi elaborado e desenvolvido para permitir a criação de uma lista de conteúdos para assistir (filmes, séries, animes, etc.), permitindo ao usuário cadastrar, visualizar, editar e remover itens de forma simples e organizada, utilizando python, css e html. Contudo esse projeto foi muio importante para o meu desenvolvimento como estudante do SENAI, consegui aprender diversas formas de aprender e me divertir om esse projeto. Usamos tambem o banco de dados SQLite para armazenamento e organização de dados.
...
3. Abra o projeto utlizando seu IDE preferido
